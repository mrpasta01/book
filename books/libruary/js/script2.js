...
function load_books(){
	...
	if(offset==17) 	$('#but_next').attr('disabled', true)
	if(offset<17) 	$('#but_next').attr('disabled', false) 
		$.ajax({
		//url: 'http://172.17.4.160/books/api_libruary/get_books.php?count=1&offset='+offset,
		url: 'http://217.71.129.139:4589/books/api_libruary/get_books.php?count=1&offset='+offset,
		method: 'get',  
		dataType: 'json',
